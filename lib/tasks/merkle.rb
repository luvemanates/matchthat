...
class MerkleTree
  ...
  def add_leaf(params)
    ...
    new_leaf = MerkleTreeNode.new(:merkle_tree_id => self.id, :ledger_entry_block_id => params[:ledger_entry_block_id], :node_type => MerkleTreeNode::LEAF, :stored_data => params[:stored_data], :fulfilled => false)
