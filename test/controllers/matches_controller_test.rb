...
class MatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create match" do
    assert_difference("Match.count") do
      post matches_url, params: { match: { base_amount: @match.base_amount, creator_id: @match.creator_id, description: @match.description, title: @match.title, total_amount: @match.total_amount } }
    end
